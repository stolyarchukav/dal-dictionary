package org.forzaverita.verbita.database.impl;
...
public class SqliteDatabase extends SQLiteOpenHelper implements Database {
	...
	private static String DB_NAME = "verbi.sqlite";
	private static String DB_PATH = "/data/data/org.forzaverita.verbita/databases/" + DB_NAME;

	private static String IVERBS_METADATA = "verbi_metadata";
